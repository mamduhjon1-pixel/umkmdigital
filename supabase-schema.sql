...
begin
  for r in select schemaname, tablename, policyname from pg_policies where schemaname = 'public' loop
    if r.tablename in ('users','products','orders','reviews','withdrawals','seller_wallets','wallet_transactions','komisi_tagihan','notifications','chats','chat_messages','admin_settings','admin_wallets','admin_commission_transactions','payments','seller_applications','seller_verifications','user_presence','carts') then
...
declare t text;
begin
  foreach t in array array['users','products','orders','reviews','withdrawals','seller_wallets','wallet_transactions','komisi_tagihan','notifications','chats','chat_messages','admin_settings','admin_wallets','admin_commission_transactions','payments','seller_applications','seller_verifications','user_presence','carts'] loop
    begin
