  ...
  useEffect(() => {
    const unsub = onAuthStateChanged(auth, async (u) => {
      try {
        ...
        setUser(u ? { ...u, uid: u.uid, authUid: u.uid } : null);
        setProfile(null);
      } finally {
        setLoading(false);
      }
...
function RegisterPage({ setPage, createNotif }) {
  ...
  async function register(e) {
    ...
    try {
      ...
      if (res.needsEmailConfirmation) alert("Pendaftaran berhasil. Silakan cek email untuk konfirmasi akun sebelum login.");
      setPage("home");
    } catch (err) {
