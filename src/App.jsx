...
export default function App() {
  ...
  useEffect(() => {
    ...
    const unsub = onAuthStateChanged(auth, async (u) => {
      ...
      // Tampilkan aplikasi segera setelah Supabase Auth memberi session.
      // Profil/role tetap dimuat setelahnya supaya login tidak terasa lama.
      ...
      try {
        ...
        try { await setUserPresence(appUser, appProfile, { reason: "auth_ready" }); } catch (presenceError) { console.warn("Gagal update presence:", presenceError); }
      } catch (error) {
