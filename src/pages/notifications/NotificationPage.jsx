...
export default function NotificationPage({ notifications = [], setPage, profile }) {
  ...
  const isAdminViewer = profile?.role === "admin" || profile?.role === "sub_admin";
      ...
      <div style={{ marginBottom: 20 }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 10 }}>
          ...
          <div style={{ display: "flex", gap: 8, flexWrap: "wrap", justifyContent: "flex-end" }}>
            {isAdminViewer && setPage && (
              <button className="btn-ghost btn-sm" onClick={() => setPage("admin")} style={{ fontSize: 12 }}>
                ← Kembali Admin
              </button>
            )}
          ...
          {sorted.map((n) => {
            ...
            return (
              <div
                ...
                style={{
                  padding: "14px 16px",
                  borderLeft: `4px solid ${isUnread(n) ? color : "var(--border)"}`,
                  background: isUnread(n) ? "#FFFBF9" : "#fff",
                  transition: "all 0.2s",
                }}
              >
                <div style={{ display: "flex", gap: 12, alignItems: "flex-start" }}>
                  ...
                  <div style={{
                    ...
                    background: isUnread(n) ? `${color}18` : "#F3F4F6",
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: 8, marginBottom: 4 }}>
                      <div style={{ fontWeight: 700, fontSize: 14, color: isUnread(n) ? "#111" : "var(--text1)", lineHeight: 1.3 }}>
                        {n.title}
                        {isUnread(n) && (
                    ...
                    <div style={{ display: "flex", gap: 8, marginTop: 10, alignItems: "center" }}>
                      ...
                      {isUnread(n) && <span style={{ color: "var(--border)", fontSize: 12 }}>|</span>}
                      <button
