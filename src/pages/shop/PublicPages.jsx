...
export function HomePage({ products, search, onProductClick, onAddToCart, user, profile, setPage, locationFilter = emptyLocationFilter, onLocationFilterChange, onResetLocationFilter }) {
...
export function ProductDetailModal({ product, reviews = [], onClose, onAddToCart, user, profile, onSellerClick, onOpenChat }) {
