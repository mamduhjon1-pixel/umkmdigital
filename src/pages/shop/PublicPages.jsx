...
export function HomePage({ products, search, onProductClick, onAddToCart, user, profile, setPage, locationFilter = emptyLocationFilter, onLocationFilterChange, onResetLocationFilter, buyerBanners = [], dataReady = true }) {
